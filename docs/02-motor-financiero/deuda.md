...
:::info Federalismo de responsabilidad: idea para el Estado (Venezuela S.A. no negocia deuda soberana)
La reestructuración de deuda soberana es competencia del Estado. Venezuela S.A. administra el fondo y las concesiones, pero no tiene autoridad para distribuir deuda a estados. Esta idea requiere legislación nacional. Venezuela S.A. puede incentivar la productividad regional vía concesiones preferenciales a estados que cumplan metas fiscales.
Post-reestructuración, los estados podrían asumir responsabilidad proporcional del servicio de la deuda reestructurada, distribuida según: **40% población + 40% capacidad productiva + 20% infraestructura**. Esto crea incentivos para que cada estado genere riqueza (para cubrir su cuota) en vez de depender de transferencias de Caracas. Un estado que atrae más inversión y formaliza más empleo reduce su carga relativa — se premia la productividad, no la dependencia. [Requiere investigación] para viabilidad legal bajo la estructura constitucional venezolana y compatibilidad con la reestructuración de deuda soberana (no subnacional).

**Precedentes internacionales:**
| País | Mecanismo | Resultado/Lección | Fuente |
|------|-----------|-------------------|--------|
| **Argentina** | Provincias acumularon deuda con presupuestos blandos. Ley de Solvencia Fiscal (1999) + LRF (2004) intentaron disciplinar. Reestructuración nacional 2002-03 incluyó refinanciamiento de deuda provincial | Solo 5 de 11 provincias con restricciones duras cumplieron. Sin enforcement real, las provincias vuelven al free-riding. **Advertencia: la co-responsabilidad sin sanciones automáticas fracasa** | [IMF Fiscal Federalism](https://www.elibrary.imf.org/display/book/9781557756633/ch016.xml) |
| **España** | FLA (Fondo de Liquidez Autonómica, 2012): gobierno central presta a comunidades autónomas que no acceden a mercados. Membresía obliga plan de ajuste | 63% de deuda regional es FLA (2024). Cataluña (33%), Valencia (22%) y Andalucía (15%) concentran 70% del fondo. **Riesgo: dependencia crónica del gobierno central** | [Scope Ratings](https://www.scoperatings.com/ratings-and-research/research/EN/178508) |
| **EE.UU. (Chapter 9)** | Municipios pueden declarar bancarrota bajo Chapter 9 (desde 1934). No existe para estados. Detroit (2013), Jefferson County (2011) son casos emblemáticos | <500 peticiones en 60+ años. No hay liquidación de activos — solo reestructuración. **Marco útil como última instancia, no como regla general** | [US Courts](https://www.uscourts.gov/court-programs/bankruptcy/bankruptcy-basics/chapter-9-bankruptcy-basics) |
| **Brasil** | LRF (2000): deuda neta/ingresos máx. 2× (estados), 1,2× (municipios). Gasto en personal máx. 60% ingresos corrientes. Aprobación por mayoría calificada | Deuda subnacional **<2% PIB** — la más baja de LATAM. Modelo más exitoso de disciplina fiscal subnacional en la región | [Banco Central do Brasil](https://www.bcb.gov.br/) |

**Lección:** Brasil es el modelo a seguir — reglas claras con enforcement real. Argentina y España son advertencias de qué pasa sin sanciones automáticas. **Referencia:** Plan Providencia por Venezuela (2026).
:::
