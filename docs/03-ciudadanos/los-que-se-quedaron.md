...
```mermaid
xychart-beta
    title "Valor real para el ciudadano — USD/mes por componente (Año 5)"
    x-axis ["Empleo", "Salud", "Educación", "Infraestr.", "Seguridad", "Pilar 1", "Título", "Dividendo"]
    y-axis "USD/mes" 0 --> 500
    bar [400, 80, 65, 50, 32, 150, 15, 14]
```
