...
```mermaid
flowchart LR
    A["🛢️ Golfo Pérsico<br/>20M bpd BLOQUEADO"] -->|"Ormuz cerrado"| B["❌ Mercado global<br/>Déficit masivo"]
    C["🇻🇪 Venezuela<br/>0.9M → 3M bpd"] -->|"5 días a Houston"| D["🇺🇸 Refinerías<br/>Golfo de México"]
    E["💰 USD 100B<br/>Inversión majors"] --> C

    style A fill:#C62828,color:#fff,stroke:#C62828
    style B fill:#C62828,color:#fff,stroke:#C62828
    style C fill:#0D47A1,color:#fff,stroke:#0D47A1
    style D fill:#00897B,color:#fff,stroke:#00897B
    style E fill:#F9A825,color:#000,stroke:#F9A825
```
