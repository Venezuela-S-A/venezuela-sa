...
```mermaid
flowchart TD
    OIL["🛢️ Petróleo + Recursos<br/>100% → Fondo Soberano"] --> FUND["💰 Fondo Soberano<br/>Rendimientos 4-5%/año"]
    TAX["📋 Impuestos Razonables<br/>~18-22% del PIB"] --> STATE["🏛️ Estado Eficiente"]
    ...
    style OIL fill:#1B3A5C,color:#fff
    style TAX fill:#558b2f,color:#fff
    style STATE fill:#C49A2A,color:#fff
    style FUND fill:#1B3A5C,color:#fff
    style PRIV fill:#37474f,color:#fff
```
