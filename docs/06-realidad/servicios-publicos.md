...
|------|----------|--------|
| Cobertura universal | OMS: 100% | Sistema único digital |
...
| Meta | Estándar | Acción |
|------|----------|--------|
| Expediente digital | Singapur | Cero papel en 5 años |
| Resolución | OECD: <6 meses civiles | Tribunales especializados + IA |
| Tribunales virtuales | UK/Singapur | 80% casos civiles |
| IA anticorrupción | Propuesta | Detectar patrones en sentencias |

## Seguridad

| Meta | Estándar | Acción |
|------|----------|--------|
| Homicidios | Chile: ~3/100k | Policía comunitaria + tech + empleo |
| Policía predictiva | LA/Singapur | IA patrones (con controles éticos) |
| Ciberseguridad | Estonia CERT-EE | Centro nacional + formación |
