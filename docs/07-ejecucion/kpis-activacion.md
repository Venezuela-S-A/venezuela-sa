...
```mermaid
flowchart TB
    E["🔴 EMERGENCIA<br/>KPI: Seguridad territorial >60%<br/>Producción >0.9M bpd<br/>Gobierno transición operativo"]
    S["🟡 ESTABILIZACIÓN<br/>KPI: PIB/cápita >USD 3K<br/>Formalización >40%<br/>Inflación <30%"]
    C["🔵 CONSTRUCCIÓN<br/>KPI: PIB/cápita >USD 5K<br/>Formalización >55%<br/>Pobreza <50%"]
    M["🟢 MADUREZ<br/>KPI: PIB/cápita >USD 8K<br/>Formalización >70%<br/>Pobreza <25%"]
