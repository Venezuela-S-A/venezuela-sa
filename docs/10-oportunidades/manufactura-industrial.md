---
sidebar_position: 14
title: "Manufactura y Zonas Industriales"
---
...
```mermaid
flowchart LR
    A["Energía barata<br/><b>USD 0.02/kWh hidro</b><br/>Gas abundante"] --> B["Ubicación<br/><b>Caribe + Atlántico</b><br/>2-5 días a EE.UU."]
    B --> C["Materia prima<br/><b>Petróleo, gas, hierro</b><br/>bauxita, acero"]
    C --> D["Economía dolarizada<br/><b>Sin riesgo cambiario</b><br/>Cero controles"]
    D --> E["NEARSHORING<br/><b>Más barato que México</b><br/>Más cerca que Asia"]
...
```mermaid
flowchart LR
    GURI["Guri<br/><b>USD 0.02/kWh</b>"] --> ALUM["Fundición aluminio<br/><b>400-640K ton/año</b>"]
    ALUM --> EXPORT["Exportación<br/><b>USD 1.5-1.8B/año</b>"]
    ALUM --> GALIO["Galio (subproducto)<br/><b>USD 200M/año</b>"]
    ALUM --> LOCAL["Construcción local<br/>Automotriz, packaging"]

    style GURI fill:#0D47A1,color:#fff
    style ALUM fill:#F9A825,color:#000
    style EXPORT fill:#00897B,color:#fff
    style GALIO fill:#E3F2FD,color:#1B2631
```
...
```mermaid
flowchart TD
    subgraph ZONAS["ZONAS INDUSTRIALES PROPUESTAS"]
        Z1["VALENCIA<br/>Ensamblaje automotriz<br/>Alimentos<br/>Plásticos"]
        Z2["CIUDAD GUAYANA<br/>Aluminio<br/>Acero<br/>DRI/HBI"]
        Z3["PUNTO FIJO<br/>Refinería rehabilitada<br/>Petroquímica"]
        Z4["PUERTO LA CRUZ / JOSE<br/>Petroquímica<br/>LNG<br/>Fertilizantes"]
        Z5["MARACAIBO<br/>Alimentos<br/>Ensamblaje<br/>Agroindustria"]
        Z6["BARQUISIMETO<br/>Alimentos<br/>Textiles<br/>Farmacéutica"]
    end

    subgraph VENTAJAS["VENTAJAS COMUNES"]
        V1["15% flat tax<br/>(no federal + estatal)"]
        V2["0% aranceles maquinaria<br/>por 10 años"]
        V3["Permiso en 30 días<br/>Ventanilla unica"]
        V4["Arbitraje ICSID<br/>Proteccion BIT"]
        V5["Repatriación libre<br/>de utilidades en USD"]
    end

    VENTAJAS --> ZONAS

    style ZONAS fill:#0D47A1,color:#fff
    style VENTAJAS fill:#00897B,color:#fff
```
...
```mermaid
xychart-beta
    title "PIB Manufacturero Proyectado (USD miles de M/año)"
    x-axis ["Año 1", "Año 2", "Año 3", "Año 5", "Año 7", "Año 10"]
    y-axis "USD miles de millones" 0 --> 25
    bar [3, 5, 8, 13, 18, 23]
    line [3, 5, 8, 13, 18, 23]
```
