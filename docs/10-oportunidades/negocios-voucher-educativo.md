---
sidebar_position: 17
title: "Negocios del Voucher Educativo"
---
...
```mermaid
flowchart TB
    V["💰 VOUCHER<br/>USD 300-500/mes por estudiante<br/>8M estudiantes = USD 29-48B/año"]
    V --> C["🏫 Colegios<br/>25.000 autónomos<br/>USD 150-250/estudiante"]
    V --> CO["🍽️ Comedores<br/>Miles de caterings<br/>USD 2-3.50/almuerzo"]
    V --> T["🚌 Transporte<br/>Rutas concesionadas<br/>USD 25-40/estudiante"]
    V --> D["⚽ Deportes<br/>Del profe de barrio<br/>a academias multi"]
    V --> M["🎵 Música/Arte<br/>Profesores individuales<br/>a academias formales"]
    V --> R["🤖 Robótica/Coding<br/>Clubes STEM<br/>pipeline tech"]
    V --> I["🌍 Idiomas<br/>Inglés + mandarín<br/>híbrido video+presencial"]
    V --> E["💻 EdTech<br/>Colegios en línea<br/>plataformas de tutores"]

    style V fill:#F9A825,color:#000
    style C fill:#0D47A1,color:#fff
    style CO fill:#00897B,color:#fff
