...
flowchart LR
    ...
    TAX["IMPUESTOS<br/><b>15% flat + 12% IVA</b><br/>= Presupuesto del Estado"] --> STATE["ESTADO<br/>5 funciones:<br/>gobierno, salud, justicia,<br/>educacion, seguridad"]

    style OIL fill:#F9A825,color:#000
    style FUND fill:#0D47A1,color:#fff
    style DIV fill:#00897B,color:#fff
    style TAX fill:#0D47A1,color:#fff
...
```mermaid
xychart-beta
    title "Producción Petrolera Venezuela (Miles bpd)"
    x-axis ["1998", "2002", "2006", "2010", "2014", "2017", "2019", "2020", "2023", "2025"]
    y-axis "Miles bpd" 0 --> 3500
    line [3400, 2600, 3000, 2800, 2700, 2200, 800, 300, 750, 1000]
```
...
```mermaid
gantt
    title Ruta a 3M bpd — Timeline Rystad Energy
    dateFormat YYYY
    axisFormat %Y

    section Fase 1: Estabilización (1-1.5M bpd)
    Workovers campos existentes            :2027, 2029
    Rehabilitacion equipos e infraestructura :2027, 2029
    Chevron expansion (licencia existente)  :2027, 2030
    Reactivacion campos convencionales      :2027, 2030

    section Fase 2: Crecimiento (1.5-2M bpd)
    Nuevas JVs con majors (Exxon, Shell)   :2029, 2033
    Desarrollo Faja del Orinoco (nuevos bloques) :2029, 2035
    Rehabilitacion de refinerias            :2029, 2033
    Oilfield services expansion             :2029, 2033

    section Fase 3: Escala (2-3M bpd)
    Producción Faja a plena capacidad       :2033, 2042
    Upgraders nuevos                        :2033, 2038
    LNG (gas natural licuado)               :2033, 2038
    Exploración offshore (gas)              :2035, 2042

    section Gas Natural
    Fin del flaring / captura de gas        :2028, 2032
    Gas a electricidad (turbinas)           :2029, 2033
    LNG export terminal                     :2033, 2038
    Gas quimico (metanol, fertilizantes)    :2030, 2035
```
...
flowchart TD
    subgraph GOB["ESTADO — Marco Legal + Seguridad"]
        G1["Nueva ley de hidrocarburos<br/>JV framework moderno"]
        G2["Protección ICSID<br/>BIT con EE.UU. y socios"]
        G3["Rondas de licitación<br/>transparentes"]
        G4["Seguridad de campos<br/>e infraestructura"]
        G5["Regulador independiente<br/>(no PDVSA-gobierno fusionado)"]
        G6["Levantamiento de sanciones<br/>(coordinado con EE.UU.)"]
    end

    subgraph PRIVADO["CAPITAL PRIVADO — Inversión + Operacion"]
        P1["Majors: Chevron, Exxon,<br/>Shell, Total, BP"]
        P2["OFS: Schlumberger,<br/>Halliburton, Baker Hughes"]
        P3["NOCs: Equinor, Petrobras,<br/>Saudi Aramco"]
        P4["Independientes: Maurel & Prom,<br/>Gran Tierra Energy"]
        P5["Financieros: PE funds,<br/>commodity traders"]
    end

    GOB --> JV["JOINT VENTURES<br/>Gobierno 30-49% / Privado 51-70%<br/>Operador privado<br/>Gobernanza tipo Santiago Principles"]
    PRIVADO --> JV
    ...
    style JV fill:#F9A825,color:#000
    style FUND2 fill:#0D47A1,color:#fff
```
...
```mermaid
pie title Destino del Gas Natural Venezolano (actual)
    "Quemado (flaring)" : 35
    "Reinyectado en pozos" : 45
    "Uso domestico / petroquimica" : 15
    "Exportacion" : 5
```
...
```mermaid
flowchart LR
    A["Venezuela<br/><b>303B barriles reservas</b><br/>1er productor potencial"] --> B["Exporta crudo<br/><b>@ USD 50-55/bbl</b><br/>(descuento calidad + sanciones)"]
    B --> C["Refinerias en el exterior<br/>procesan el crudo"]
    C --> D["Gasolina refinada<br/><b>@ USD 80-100/bbl equiv.</b>"]
    D --> E["Venezuela IMPORTA<br/>gasolina que podria<br/>refinar localmente"]
...
```mermaid
flowchart TD
    BARREL["1 BARRIL<br/><b>USD 60</b>"] --> COST["Costo de producción<br/><b>USD 15-25</b>"]
    BARREL --> ROYAL["Regalias al Estado<br/><b>USD 7-10</b> (12-16%)"]
    BARREL --> PROFIT["Ganancia JV<br/><b>USD 25-38</b>"]
    ...
    TAX2 --> STATE2["PRESUPUESTO<br/>ESTADO"]

    style BARREL fill:#F9A825,color:#000
    style FUND3 fill:#0D47A1,color:#fff
...
```mermaid
flowchart LR
    subgraph VENTANA["VENTANA: 10-15 ANOS"]
        V1["2027-2032<br/>Recuperar producción<br/>1M → 2M bpd"]
        V2["2032-2037<br/>Maximizar producción<br/>2M → 3M bpd"]
        V3["2037-2042<br/>Extraer maximo valor<br/>Mientras el petróleo vale algo"]
    end

    subgraph TRANSICION["TRANSICION ENERGETICA"]
        T1["2027-2030<br/>Solar < carbon"]
        T2["2030-2035<br/>Solar < gas natural"]
        T3["2035-2040<br/>Solar < crudo pesado<br/><b>Faja no competitiva</b>"]
    ...
    style FUND4 fill:#0D47A1,color:#fff
    style POST fill:#00897B,color:#fff
```
...
```mermaid
xychart-beta
    title "Producción Petrolera e Ingreso (15 años)"
    x-axis ["Año 1", "Año 3", "Año 5", "Año 7", "Año 10", "Año 15"]
    y-axis "USD miles de millones" 0 --> 70
    bar [22, 29, 37, 46, 55, 66]
