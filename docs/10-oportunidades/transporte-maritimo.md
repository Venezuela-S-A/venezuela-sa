---
sidebar_position: 16
title: "Transporte Marítimo, Ferris, Puertos y Cruceros"
evaluators:
  - milei
  - austrian-school
  - juan-ramon-rallo
...
```mermaid
flowchart TD
    subgraph COSTA["COSTA CARIBEÑA — 2.800+ km"]
        LG["La Guaira<br/>Acceso a Caracas<br/>6M+ hab."]
        PC["Puerto Cabello<br/>Puerto #1 del país<br/>810K TEU capacidad"]
        MAR["Margarita<br/>Isla caribeña<br/>Duty-free histórico"]
        LR["Los Roques<br/>Archipielago pristino<br/>Coral + turquesa"]
        OTROS["Coche, Cubagua,<br/>La Tortuga, Las Aves,<br/>Los Testigos"]
    end

    subgraph RIO["ORINOCO — 450+ km navegables"]
        CG["Ciudad Guayana<br/>Hub minero/industrial"]
        DELTA["Delta del Orinoco<br/>Salida al Atlántico"]
    end

    subgraph MERCADO["MERCADO CARIBE"]
        CR["32M+ cruceristas/año"]
        CARGO["Rutas comerciales<br/>Asia-EE.UU.-Europa"]
        INTER["Trinidad, Curazao,<br/>Bonaire, Aruba"]
    end

    COSTA --> MERCADO
    RIO --> COSTA
    CG -->|"Minerales + carga"| DELTA
    DELTA -->|"Atlántico"| MERCADO

    style COSTA fill:#0D47A1,color:#fff
    style RIO fill:#00897B,color:#fff
...
```mermaid
xychart-beta
    title "Inversión por sub-sector marítimo (USD M — rango inferior)"
    x-axis ["Puertos carga", "Cruceros", "Ferris", "Orinoco", "Hub integrado"]
    y-axis "USD millones" 0 --> 8500
    bar [4400, 800, 470, 1050, 850]
```
...
flowchart LR
    subgraph GOB["ESTADO — Marco Legal + Seguridad"]
        A["Marco legal<br/>Ley de puertos + ferris"]
        B["Seguridad<br/>Guardacostas + Capitanía"]
        C["Permisos<br/>Concesiones marítimas"]
        D["Velocidad<br/>Fast-track regulatorio"]
    end

    subgraph PRIVADO["CAPITAL PRIVADO"]
        E["Inversión<br/>USD 7-14B"]
        F["Tecnologia<br/>Smart ports, IoT, digital twin"]
        G["Ejecución<br/>Construcción + equipamiento"]
        H["Operación<br/>25-30 años"]
    end

    subgraph CONTRATOS["ESTRUCTURA CONTRACTUAL"]
        I["FIDIC Silver Book<br/>(EPC turnkey)"]
        J["BOT / BOOT<br/>25-30 años"]
        K["Arbitraje ICSID<br/>+ BIT"]
        L["Auditoría Big 4<br/>+ multilateral"]
    end

    GOB --> CONTRATOS
    PRIVADO --> CONTRATOS
    CONTRATOS --> RESULT["RESULTADO<br/>Puertos clase mundial<br/>Cruceros operativos<br/>Ferris confiables<br/>Orinoco navegable<br/>Hub integrado"]

    style GOB fill:#0D47A1,color:#fff
    style PRIVADO fill:#F9A825,color:#000
    style CONTRATOS fill:#00897B,color:#fff
    style RESULT fill:#E3F2FD,color:#1B2631
```
...
```mermaid
xychart-beta
    title "Revenue total transporte marítimo (USD M/año)"
    x-axis ["Ano 1", "Ano 2", "Ano 3", "Ano 5", "Ano 7", "Ano 10"]
    y-axis "USD millones" 0 --> 3000
    bar [50, 150, 400, 1000, 1800, 2800]
```
...
```mermaid
gantt
    title Plan de Transporte Marítimo — 10 Años
    dateFormat YYYY
    axisFormat %Y

    section Sprint: Marco Legal + Quick Wins (Año1)
    Ley de puertos y concesiones marítimas           :s1a, 2027, 180d
    Auditoría estado actual puertos                   :s1b, 2027, 120d
    Licitación Puerto Cabello (BOT)                   :s1c, 2027, 270d
    Primeras rutas de ferry La Guaira-Margarita       :s1d, 2027, 365d
    Modernización guardacostas + VTMS                 :s1e, 2027, 365d

    section Fase 2: Concesiones + Cruceros (Años2-5)
    Rehabilitación Puerto Cabello                     :f2a, 2028, 1460d
    Modernización La Guaira                           :f2b, 2028, 1095d
    Terminal de cruceros La Guaira                     :f2c, 2028, 1095d
    Terminal de cruceros Margarita                     :f2d, 2029, 730d
    Expansión sistema de ferris (6-8 rutas)           :f2e, 2028, 1460d
    Dragado Orinoco + señalización                    :f2f, 2028, 1095d

    section Fase 3: Expansión (Años3-7)
    Deep-water port (Jose/Paria)                      :f3a, 2030, 1825d
    Hub integrado Puerto Cabello (aeropuerto)         :f3b, 2030, 1825d
    Terminales fluviales Orinoco (4-6)                :f3c, 2030, 1460d
    Ferris internacionales (Trinidad, ABC)            :f3d, 2030, 1095d
    Terminal cruceros Puerto Cabello                   :f3e, 2031, 1095d

    section Fase 4: Hub Regional (Años7-10)
    Puerto Cabello 2M+ TEU operativo                  :f4a, 2034, 1095d
    2M+ cruceristas/año                               :f4b, 2034, 1095d
    Orinoco 20M+ ton/año                              :f4c, 2034, 1095d
    Zona franca operativa + 500 empresas              :f4d, 2034, 1095d
```
