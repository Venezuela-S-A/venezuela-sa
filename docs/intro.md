...
Cuando el plan dice "Año 5" o "Año 10", NO es una promesa de calendario. Lo que activa cada fase son **condiciones verificables** (metas medibles): PIB per cápita, nivel de formalización, tasa de pobreza, producción petrolera. Si las condiciones se cumplen en 3 años, se acelera. Si tardan 12, se espera. **El plan se adapta a la realidad, no al revés.** Ver [Condiciones de Activación](/07-ejecucion/kpis-activacion) para los detalles.
:::
