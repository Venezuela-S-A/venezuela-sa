...
## "Venezuela Awaits You" Program

### Component 1: Economic Incentives

| Incentive | Detail | Model |
|-----------|--------|-------|
| Repatriation bonus | USD 2,000-5,000 per family | Israel: Law of Return |
| Housing subsidy | 6 months of rent in ZEET zone | — |
| Degree recognition | Express validation (30 days) | Chile/Colombia |
| Tax exemption | 2 years income tax-free | Ireland for returnees |

### Component 2: Job Placement

| Channel | Description |
|---------|-------------|
| Diaspora-Venezuela Hub (Pre-Seed) | Matching platform: returning talent + jobs in ZEETs, PDVSA JVs, hospitals, schools |
| Prioritized public program | Returnees with experience have priority in public hiring (police, healthcare, education) |
| Facilitated entrepreneurship | Direct access to Semilla/Ignite Venezuela programs (see [Startups](/05-transformacion/startup-programs)) |

### Component 3: Bilateral Model

Not every returnee comes back physically. The bilateral model allows contributing from abroad:

| Modality | Description | Benefit |
|----------|-------------|---------|
| **Physical return** | Move to Venezuela | Full incentives |
| **Partial return** | 3-6 months/year in Venezuela | Partial incentives + maintained residency in host country |
| **Remote contribution** | Remote work for Venezuelan companies | Tech visa + intl. contract |
| **Direct investment** | Invest in bonds/startups from abroad | Citizen bonds + VIN |
| **Mentorship** | Advise startups/institutions | Program advisor network |
...
**Total return program investment:** USD 500-1,500M over 7 years (repatriation bonuses + platform + subsidies).
