...
flowchart TD
    ...
    STATE --> S1["⚙️ Government<br/>Minimal administration"]
    STATE --> S2["🏥 Healthcare<br/>Universal coverage"]
    STATE --> S3["⚖️ Justice<br/>Independent courts"]
    STATE --> S4["📚 Education<br/>Quality public education"]
    STATE --> S5["🔒 Security<br/>Professional police"]
    PRIV["🏗️ Private Sector"] --> I1["Infrastructure<br/>Concessions"]
    PRIV --> I2["Pensions<br/>Individual accounts"]
    PRIV --> I3["Complementary healthcare<br/>Private insurance"]
    PRIV --> I4["Telecommunications"]
    PRIV --> I5["Public services<br/>Water, electricity"]
...
flowchart TB
    ...
    TAX --> P1["👴 Pillar 1 Pension<br/>Universal for every retiree"]
    TAX --> SOL["❤️ Solidarity<br/>Health Tramo A/B + minors"]
...
```mermaid
flowchart LR
    F1["Years 1-5<br/>FONASA 100%<br/>Pure solidarity<br/>No one left out"] --> F2["Years 5-10<br/>FONASA 5% + Medisave 2%<br/>Individual savings introduced"]
    F2 --> F3["Years 10-15<br/>FONASA 4% + Medisave 3%<br/>Middle class saves"]
    F3 --> F4["Years 15+<br/>FONASA 3% + Medisave 4%<br/>Chile-Singapore hybrid"]
...
```mermaid
flowchart TB
    V["💰 UNIVERSAL VOUCHER<br/>Follows the student — not the school"]
    V --> C1["🏫 Private School<br/>Traditional"]
    V --> C2["🏢 Public School<br/>→ Autonomous Enterprise"]
    V --> C3["💻 Online School<br/>+ Tutor Network"]
    V --> C4["🎵 Activities<br/>Languages, music, arts,<br/>sports, robotics"]

    AUD["📋 AUDITING + EVALUATION<br/>Schools audited on results<br/>Teachers evaluated periodically<br/>Performance bonuses"]
...
```mermaid
flowchart TB
    UNI["🎓 PUBLIC UNIVERSITY<br/>Autonomous + Self-Sustaining"]
    UNI --> V["💰 Vouchers per student<br/>(earned by merit)"]
    UNI --> ID["🔬 R&D + Patents<br/>Licenses → royalties"]
    UNI --> AL["🤝 Private Alliances<br/>Chairs + laboratories"]
    UNI --> SP["🚀 Spin-offs<br/>Incubators → startups"]
    UNI --> CO["📋 Consulting<br/>Technical services"]
    UNI --> EC["📚 Continuing Education<br/>Masters + certifications"]

    EST["👤 STUDENT"]
    EST -->|"Merit: grades + admission"| V
    EST -->|"Automatic FONASA health"| SAL["🏥 Health covered"]
    EST -->|"If Tramo A/B"| ALIM["🍽️ Meals"]

    SUP["📋 TRIPARTITE OVERSIGHT<br/>State + Academic Community + Students"]
    UNI --> SUP
...
```mermaid
xychart-beta
    title "Projected Tax Revenue (USD billions)"
    x-axis ["Year 3", "Year 7", "Year 15"]
...
```mermaid
xychart-beta
    title "Tax Composition — Year 15 (USD billions)"
    x-axis ["VAT 12%", "Personal Income 15%", "Corporate Income 15%", "Property + other"]
    y-axis "USD billions" 0 --> 15
    bar [14, 12, 10, 5]
```
...
```mermaid
xychart-beta
    title "Public Spending as % of GDP — Comparison"
    x-axis ["Singapore", "Venezuela target", "Georgia", "Chile", "Estonia", "OECD avg."]
    y-axis "% of GDP" 0 --> 45
...
```mermaid
xychart-beta
    title "Corporate Tax — Comparison (%)"
    x-axis ["Venezuela target", "Georgia", "Singapore", "Estonia", "Chile", "Argentina"]
    y-axis "Rate %" 0 --> 35
...
```mermaid
flowchart LR
    A["Day 1–90<br/>Full audit"] --> B["Month 3–6<br/>Ministry mergers<br/>Eliminate duplicates"]
    B --> C["Month 6–12<br/>Retirement + Reskilling<br/>+ Entrepreneurship"]
    C --> D["Year 1–2<br/>Digital state<br/>automated, efficient"]
...
```mermaid
xychart-beta
    title "Public Employees — Transition (thousands)"
    x-axis ["Today", "Year 1", "Year 3", "Year 5", "Year 7"]
    y-axis "Thousands of employees" 0 --> 2600
...
```mermaid
xychart-beta
    title "Funding Sources by Phase (USD billions)"
    x-axis ["Year 1", "Year 3", "Year 7", "Year 15"]
...
```mermaid
xychart-beta
    title "FCV Accumulated by Age — Minimum Wage (USD thousands)"
    x-axis ["18", "25", "30", "35", "40", "50", "60", "65"]
    y-axis "USD thousands" 0 --> 500
