...
> Format based on the standard Y Combinator application. Adapted for a "Startup Nation" model where the product is a country.
...
|--------|-----------|----------------|
| Oil production | 2.75M bpd x $60/bbl net margin | USD 30B+/year |
...
|-------|------|-----------|--------|
| Pre-Seed platforms | USD 25-60M | Diaspora (1% x $500) | 12-18 months |
...
```mermaid
flowchart TB
    Y1["<b>Year 1-3: Stabilize</b><br/>Emergency humanitarian<br/>Police reform (Georgia)<br/>Dollarization<br/>Oil production: 1→1.4M bpd"]
    Y5["<b>Year 3-7: Build</b><br/>Infrastructure<br/>ZEET zones operational<br/>Data centers<br/>Oil: 1.5→2.5M bpd"]
    Y10["<b>Year 7-12: Diversify</b><br/>6 engines active<br/>VIN IPO<br/>Fund > $100B<br/>Oil < 45% exports"]
    Y15["<b>Year 12-15: Harvest</b><br/>Fund: $250-400B<br/>Dividends: $125-200/person<br/>Oil < 35% exports<br/>Top 3 LATAM economy"]
...
Venezuela S.A. is an open-source plan. The founding team is built with the Pre-Seed. The diaspora has the necessary talent in key global positions.

**Required profiles:**

| Role | Profile | Why |
|-----|--------|---------|
| CEO | Experience in sovereign restructurings or national M&A | Country-scale leadership |
| CFO | Sovereign debt + sovereign wealth funds | Fund financial architecture |
| CTO | Estonia e-gov or Singapore GovTech | Digital state from scratch |
| COO | Public-private concessions (Chile/Colombia) | Infrastructure at scale |
| Diaspora Lead | Global Venezuelan networks + tech | Pre-Seed mobilization |

**What founders must have achieved:** rebuilt something from zero, managed capital at scale, built technology serving millions, or led institutional reform.
:::
...
**10-25s:** "Venezuela has the world's largest oil reserves and 82.8% lives in poverty. Our plan uses oil as fuel to build a tech economy. The cheapest hydroelectric energy on the continent attracts BigTech. The ecosystem diversifies the economy. And a sovereign fund pays dividends to every citizen."

**25-45s:** "We already have Chevron operating, USD 1B+ generated in U.S.-controlled oil sales, the Dragon Field project with Trinidad signed, and a plan with 85+ verifiable sources published on GitHub."

**45-60s:** "The Pre-Seed of USD 25-60M comes from the diaspora. No government. If 1% of 7.9 million invest USD 500, it's done. Venezuela is not a problem to solve. It's a business to build."
:::
