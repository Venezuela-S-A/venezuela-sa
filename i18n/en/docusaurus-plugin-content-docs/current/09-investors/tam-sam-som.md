...
```mermaid
flowchart TB
    TAM["<b>TAM — USD 3.5T/year</b><br/>Global markets: oil + gas + data centers +<br/>LATAM tourism + agroindustry + renewables"]
    SAM["<b>SAM — USD 200-350B/year</b><br/>Addressable: 3M bpd production +<br/>LATAM DC + Caribbean tourism + regional gas"]
...
xychart-beta
    ...
    x-axis ["Oil", "Taxes", "SWF Return", "Tourism", "Tech/DC", "Gas", "Petrochem", "Agro", "Renew."]
