...
```mermaid
flowchart TD
    subgraph RESIDENCIAL["RESIDENTIAL — 70% of market"]
        R1["Social housing<br/><b>100K units/year</b><br/>Modular/prefab"]
        R2["Middle-class housing<br/>Residential complexes"]
        R3["Premium housing<br/>Returning diaspora"]
    end

    subgraph COMERCIAL["COMMERCIAL — 20% of market"]
        C1["Shopping centers<br/>Rehabilitation + new"]
        C2["Office parks<br/>For ZEETs and companies"]
        C3["Hotels<br/>Tourism + business"]
    end

    subgraph INDUSTRIAL["INDUSTRIAL — 10% of market"]
        I1["Industrial parks<br/>Near ZEETs"]
        I2["Manufacturing plants<br/>Industrial buildings"]
        I3["Logistics infrastructure<br/>Warehouses, dry ports"]
    end
...
```mermaid
flowchart LR
    A["Cement<br/><b>Production: <2 M tons</b><br/>Need: 10-15 M tons"] --> B["Rebar/Steel<br/><b>Production: <200K tons</b><br/>Need: 1-2 M tons"]
    B --> C["Glass/Ceramics<br/><b>Production: ~0</b><br/>Total import"]
    C --> D["Machinery<br/><b>Fleet: ~0</b><br/>No cranes, no mixers"]
    D --> E["Labor<br/><b>Deficit: 500K+</b><br/>Emigrated"]
...
```mermaid
gantt
    title National Housing Plan — 15 Years
    dateFormat YYYY
    axisFormat %Y

    section Phase 1: Emergency
    Prefab plants (3-5 plants)            :2027, 2029
    First 20K units                       :2028, 2029
    Basic mortgage credit                 :2028, 2029

    section Phase 2: Scale
    Scale to 50K units/year              :2029, 2031
    10 prefab plants operating           :2029, 2031
    Middle-class housing program         :2030, 2032

    section Phase 3: Cruising Speed
    100K units/year sustained            :2031, 2037
    Premium housing for diaspora         :2032, 2037
    Existing stock rehabilitation        :2031, 2037

    section Phase 4: Consolidation
    Self-sustaining market               :2037, 2042
    Deficit reduced to <500K             :2037, 2042
    Export capacity to Caribbean         :2038, 2042
```
...
```mermaid
flowchart LR
    subgraph GOB["STATE — Regulatory framework"]
        G1["Zoning reform<br/>Simplify categories"]
        G2["Fast-track permits<br/>30 days max"]
        G3["Land bank<br/>for social housing"]
        G4["Digital property registry<br/>(blockchain)"]
        G5["Mortgage credit<br/>via reformed banking"]
        G6["Legal security<br/>BIT + ICSID"]
    end

    subgraph PRIVADO["PRIVATE CAPITAL — Execution"]
        P1["International<br/>construction firms"]
        P2["Prefab factories<br/>CEMEX, LafargeHolcim"]
        P3["REITs<br/>Real estate funds"]
        P4["Developers<br/>Residential + commercial"]
        P5["Infrastructure<br/>investment funds"]
    end

    GOB --> MERCADO["MARKET<br/>USD 10-20B/year"]
    PRIVADO --> MERCADO
...
```mermaid
flowchart TD
    subgraph FINANCIAMIENTO["CAPITAL SOURCES"]
        F1["International REITs<br/>Brookfield, Prologis"]
        F2["Development funds<br/>IFC, IDB, CAF"]
        F3["Construction firms (equity)<br/>VINCI, ACS, Sacyr"]
        F4["Mortgage credit<br/>Reformed banking"]
    end

    subgraph EJECUCION["EXECUTION"]
        E1["Prefab plants<br/>CEMEX, LafargeHolcim, BROAD"]
        E2["Construction firms<br/>VINCI, ACS, Sacyr + local"]
        E3["Developers<br/>Residential + commercial"]
    end

    subgraph PRODUCTO["PRODUCT"]
        P1["Social housing<br/>60K/year"]
        P2["Middle-class housing<br/>25K/year"]
        P3["Commercial + industrial<br/>15K/year equiv."]
    end

    FINANCIAMIENTO --> EJECUCION
    EJECUCION --> PRODUCTO
    PRODUCTO --> REV["REVENUE<br/>USD 10-20B/year"]
...
```mermaid
xychart-beta
    title "Venezuela Construction Market — Projection (USD billions/year)"
    x-axis ["Year 1", "Year 2", "Year 3", "Year 5", "Year 7", "Year 10"]
