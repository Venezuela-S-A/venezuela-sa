...
triggers:
  - When evaluating oil-dependent debt restructuring or Chinese bilateral debt
  - When analyzing IMF program completion in petro-states
  - For the most directly comparable precedent to Venezuela (Ecuador)
---
...
- Restructuring oil-dependent sovereign debt with constrained fiscal space
- Chinese bilateral debt renegotiation (CDB/Eximbank structure and leverage points)
- IMF program design and completion for petro-states
- Managing the political economy of austerity in populist environments
- Converting oil-for-loans into more sustainable structures
...
5. **Sequencing**: IMF first (gives DSA credibility), then bonholders (using IMF cover), then China (bilaterally, last). This is the proven sequence.

## Their Bias

- Sees everything through Ecuador precedent (useful but not identical)
- Favors IMF-first sequencing because that is what worked for him
- May underestimate how much harder Venezuela is: 10x the debt, 20x the political complexity
