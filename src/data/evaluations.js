...
// Score actual: 7.7/10 (45 perspectivas)
...
export const PERSPECTIVES = [
  ...
  },
  {
    ...
    sections: ['estado-digital', 'tech-hubs', 'infraestructura', 'transformacion'],
  ...
  // --- Centro ---
  {
    ...
    sections: ['motor-financiero', 'diversificacion', 'transformacion', 'fondo-soberano'],
  ...
  },
  {
    ...
    sections: ['gobernanza', 'motor-financiero', 'ciudadanos', 'fondo-soberano'],
  ...
  },
  {
    ...
    sections: ['motor-financiero', 'fiscal', 'diversificacion', 'transformacion'],
  ...
  // --- Inversor/Tech ---
  {
    ...
    sections: ['tech-hubs', 'estado-digital', 'infraestructura', 'transformacion'],
...
export function getSectionSummaries() {
  ...
  return Object.entries(sectionMap).map(([section, perspectives]) => {
