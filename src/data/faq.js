...
const FAQ = [
  ...
  {
    keywords: ['dinero', 'financiamiento', 'fuente', 'ingreso', 'revenue', 'plata'],
  ...
  {
    keywords: ['fcv', 'fondo ciudadano', 'cuenta', 'cpf', 'singapur', 'retiro', 'pension'],
  ...
  {
    keywords: ['socialismo', 'comunismo', 'capitalismo', 'izquierda', 'derecha'],
  ...
  },
  {
    ...
    a: 'No. El plan es 100% apartidista. Cero propaganda politica a favor o en contra de ningun politico. El plan sirve a ciudadanos, no a partidos. Se evalua con 28 perspectivas ideologicas que van desde Milei (libertario) hasta Piketty (izquierda), pasando por Hausmann, Acemoglu, Lee Kuan Yew, y mas.',
  },
  {
  ...
  },
  {
    ...
    a: 'El plan se evalua con 28 perspectivas y tiene score 7.7/10. Cada dato tiene fuente verificable. Los modelos de referencia son paises reales: Noruega (fondo soberano), Singapur (estado lean + CPF), Estonia (estado digital), Georgia (reforma policial), Chile (FONASA + vouchers educativos), Rwanda (reconstruccion post-conflicto). No es facil. Pero "dificil" no es "imposible".',
  },
  {
